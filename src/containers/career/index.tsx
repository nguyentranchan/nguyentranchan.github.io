...
export class Career extends React.Component {
  render() {
    return (
      <div id="career" className="container-lg mt-16 px-6 md:px-16 lg:px-18">
        ...
        <div className="md:inline-flex pt-4">
          <div className="md:w-1/2 flex flex-col md:mr-4">
            ...
            <p className="pt-2 pb-4">
              ...
              amet nisl. Ut non lacinia urna. Quisque id nulla quis mauris ultricies viverra.
            </p>
          ...
          <div className="md:w-1/2 pt-4">
            <div className="job inline-flex">
              ...
              <div className="flex flex-col pl-4">
                ...
                <p>
                  Vivamus a turpis non ligula scelerisque bibendum non et lectus. Quisque ullamcorper, purus sit amet
                  tempor tristique, mauris metus facilisis elit, at pulvinar magna orci in ex.{' '}
                </p>
              </div>
            </div>
