  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div className="contact pl-6 flex flex-col text-center md:text-left pt-10 md:pt-0 max-w-xs">
        ...
        <div className="contact pl-6 text-center md:text-left pt-10 md:pt-0 max-w-xs">
